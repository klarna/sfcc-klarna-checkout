...
function Handle(lineItemCtnr) {
    var KLARNA_CHECKOUT_METHOD = require('*/cartridge/scripts/util/klarnaConstants.js').PAYMENT_METHOD;
    var paymentInstrs = [];
    var iter = {};
    var existingPI = {};
    var amount = 0;
    ...
    Transaction.wrap(function () {
        ...
        lineItemCtnr.createPaymentInstrument(KLARNA_CHECKOUT_METHOD, amount);
    });
